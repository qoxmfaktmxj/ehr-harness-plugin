...
**추천: A** — 경량 원칙. fixture 로 정확도 90% 이상 확보 가능. B 는 v1.11+ 옵션.
...
**추천: A** — v1.10 본 목적은 self-evolving. 분석 정확도는 별도 작업.
...
- 본 v2 가 권위 있는 설계 문서.
- writing-plans 스킬 호출 시 v2 만 참조.

---

**Next**: 외부 평가자 재평가 → (통과 시) writing-plans 스킬로 implementation plan 생성 → TDD 실행.
